 ...
 */
function marfoof_connect_create_tracking_table() {
    global $wpdb;
 ...
 */
function marfoof_connect_get_migration_stats($type = 'products') {
    global $wpdb;
    $table_name = $wpdb->prefix . 'marfoof_migration_tracking';
 ...
 */
function marfoof_connect_get_migration_offset($type) {
    global $wpdb;
    $table_name = $wpdb->prefix . 'marfoof_migration_tracking';
 ...
 */
function marfoof_connect_is_item_migrated($type, $item_id) {
    global $wpdb;
    $table_name = $wpdb->prefix . 'marfoof_migration_tracking';
 ...
 */
function marfoof_connect_mark_item_migrated($type, $item_id, $batch_number = 1, $error = null) {
    global $wpdb;
    $table_name = $wpdb->prefix . 'marfoof_migration_tracking';
